...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnRegister,
      @NonNull TextInputEditText etAge, @NonNull TextInputEditText etCity,
      @NonNull TextInputEditText etFullName, @NonNull TextInputEditText etPassword,
      @NonNull TextInputEditText etSport, @NonNull TextInputEditText etUsername,
      @NonNull TextInputEditText etYears, @NonNull TextView tvLogin) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ScrollView) rootView, btnRegister, etAge, etCity,
          etFullName, etPassword, etSport, etUsername, etYears, tvLogin);
    }
